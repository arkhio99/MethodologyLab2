...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.table_feature.setGeometry(QtCore.QRect(10, 150, 441, 261))
        ...
        self.btn_add_example.setGeometry(QtCore.QRect(1180, 38, 91, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.list_features.setGeometry(QtCore.QRect(700, 140, 351, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.list_features.setFont(font)
        self.list_features.setObjectName("list_features")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(700, 110, 381, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(60, 420, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lbl_eigen_value_example.setGeometry(QtCore.QRect(904, 420, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_8.setGeometry(QtCore.QRect(740, 420, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.lbl_concord_estimate_example = QtWidgets.QLabel(self.centralwidget)
        self.lbl_concord_estimate_example.setGeometry(QtCore.QRect(904, 457, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_9.setGeometry(QtCore.QRect(861, 440, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.lbl_concord_index_example = QtWidgets.QLabel(self.centralwidget)
        self.lbl_concord_index_example.setGeometry(QtCore.QRect(904, 438, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_10.setGeometry(QtCore.QRect(860, 460, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.btn_calc_feature_priority = QtWidgets.QPushButton(self.centralwidget)
        self.btn_calc_feature_priority.setGeometry(QtCore.QRect(460, 119, 181, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.btn_calc_example_priority_by_feature.setGeometry(QtCore.QRect(1070, 140, 201, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.btn_calc_example_priotity.setGeometry(QtCore.QRect(470, 490, 311, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.cb_example_1.setGeometry(QtCore.QRect(703, 70, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.text_editor_example_priority.setGeometry(QtCore.QRect(1090, 70, 91, 31))
        ...
        self.cb_example_2.setGeometry(QtCore.QRect(890, 70, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btn_set_example_priority.setGeometry(QtCore.QRect(1180, 70, 93, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.table_feature_priorities.setGeometry(QtCore.QRect(560, 149, 81, 261))
        ...
        self.table_example_priorities_by_feature.setGeometry(QtCore.QRect(1177, 170, 91, 241))
        ...
        self.table_example_priorities.setGeometry(QtCore.QRect(15, 530, 1251, 192))
        ...
        self.table_feature_eigen_vector.setGeometry(QtCore.QRect(460, 149, 91, 261))
        ...
        self.table_example_eigen_vector_by_feature.setGeometry(QtCore.QRect(1070, 170, 101, 241))
    ...
    def _setActions(self):
        ...
        self.btn_calc_feature_priority.clicked.connect(self._updateFeatureEstimates)
        self.btn_calc_feature_priority.clicked.connect(self._updateFeatureEigenTable)
        self.btn_calc_example_priority_by_feature.clicked.connect(self._updateExamplePriorityByFeatureTable)
        self.btn_calc_example_priority_by_feature.clicked.connect(self._updateExamplePriorityByFeatureEstimates)
        self.btn_calc_example_priority_by_feature.clicked.connect(self._updateExampleEigenByFeatureTable)
    ...
    def _updateFeaturePriorityTable(self):
        ...
        self.table_feature_priorities.setHorizontalHeaderLabels(["Приоритеты"])
    ...
    def _updateFeatureEstimates(self):
    ...
    def _updateFeatureEigenTable(self):
        if self._matrix is None:
            return

        feature_eigen_vector = self._matrix.get_feature_eigen_vector()
        self.table_feature_eigen_vector.setRowCount(len(feature_eigen_vector))
        self.table_feature_eigen_vector.setColumnCount(1)
        self.table_feature_eigen_vector.setHorizontalHeaderLabels(["Собст. вектор"])
        for i in range(0, len(feature_eigen_vector)):
            cell_value = QtWidgets.QTableWidgetItem("%.2f" % (feature_eigen_vector[i]))
            self.table_feature_eigen_vector.setItem(i, 0, cell_value)
    ...
    def _updateExamplePriorityByFeatureTable(self):
        ...
        self.table_example_priorities_by_feature.setRowCount(len(example_by_feature_priority_vector))
        self.table_example_priorities_by_feature.setColumnCount(1)
        self.table_example_priorities_by_feature.setHorizontalHeaderLabels(["Приоритеты"])
        for i in range(0, len(example_by_feature_priority_vector)):
            ...
            self.table_example_priorities_by_feature.setItem(i, 0, cell_value)

    def _updateExamplePriorityByFeatureEstimates(self):
        feature = self.list_features.currentText()
    ...
    def _updateExampleEigenByFeatureTable(self):
        if self._matrix is None:
            return

        feature = self.list_features.currentText()
        example_by_feature_eigen_vector = self._matrix.get_example_eigen_vector(feature)
        self.table_example_eigen_vector_by_feature.setRowCount(len(example_by_feature_eigen_vector))
        self.table_example_eigen_vector_by_feature.setColumnCount(1)
        self.table_example_eigen_vector_by_feature.setHorizontalHeaderLabels(["Собств.вектор"])
        for i in range(0, len(example_by_feature_eigen_vector)):
            cell_value = QtWidgets.QTableWidgetItem("%.2f" % (example_by_feature_eigen_vector[i]))
            self.table_example_eigen_vector_by_feature.setItem(i, 0, cell_value)
    ...
    def _loadExample(self):
        ...
        self.cb_example_2.addItems(examples)
